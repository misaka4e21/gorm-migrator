...
func (c PgColumn) DatabaseTypeName() string {
	return c.datatype
}

func (c PgColumn) Length() (length int64, ok bool) {
	ok = c.maxlen.Valid
	if ok {
...
func (c PgColumn) Nullable() (nullable bool, ok bool) {
	if c.nullable.Valid {
...
func (c PgColumn) DecimalSize() (precision int64, scale int64, ok bool) {
...
func (m PgMigrator) CurrentDatabase() (name string) {
	m.DB.Raw("SELECT CURRENT_DATABASE()").Row().Scan(&name)
	return
}

func (m PgMigrator) BuildIndexOptions(opts []schema.IndexOption, stmt *gorm.Statement) (results []interface{}) {
...
func (m PgMigrator) HasIndex(value interface{}, name string) bool {
	var count int64
...
func (m PgMigrator) CreateIndex(value interface{}, name string) error {
...
func (m PgMigrator) RenameIndex(value interface{}, oldName, newName string) error {
	return m.RunWithValue(value, func(stmt *gorm.Statement) error {
		return m.DB.Exec(
...
func (m PgMigrator) DropIndex(value interface{}, name string) error {
	return m.RunWithValue(value, func(stmt *gorm.Statement) error {
		if idx := stmt.Schema.LookIndex(name); idx != nil {
			name = idx.Name
		}
...
func (m PgMigrator) CreateTable(values ...interface{}) (err error) {
...
func (m PgMigrator) HasTable(value interface{}) bool {
	var count int64
	m.RunWithValue(value, func(stmt *gorm.Statement) error {
...
func (m PgMigrator) DropTable(values ...interface{}) error {
...
func (m PgMigrator) AddColumn(value interface{}, field string) error {
...
func (m PgMigrator) HasColumn(value interface{}, field string) bool {
	var count int64
	m.RunWithValue(value, func(stmt *gorm.Statement) error {
		name := field
		if field := stmt.Schema.LookUpField(field); field != nil {
...
func (m PgMigrator) MigrateColumn(value interface{}, field *schema.Field, columnType gorm.ColumnType) error {
...
func (m PgMigrator) HasConstraint(value interface{}, name string) bool {
	var count int64
	m.RunWithValue(value, func(stmt *gorm.Statement) error {
		return m.DB.Raw(
...
func (m PgMigrator) ColumnTypes(value interface{}) (columnTypes []gorm.ColumnType, err error) {
...
func (m PgMigrator) CurrentSchema(stmt *gorm.Statement) interface{} {
